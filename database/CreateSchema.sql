...
-- TODO Old SQL tables are kept for now, but should be removed when 
-- the SQL module is rewritten to use the new tables (in part 3).
...
-- Table SqlAnswer
--
-- TODO Is column LangCode needed?
-- ---------------------------------------------------------------------------
